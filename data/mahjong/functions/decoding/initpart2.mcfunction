# summon entity
execute at @s run summon minecraft:armor_stand ~ ~ ~8 {CustomName:"\"agari2\"",Invisible:1b,NoGravity:1b,Invulnerable:1b,Tags:["mahjong.agari","mahjong.agariprev"]}
# set tmp value
scoreboard players operation @e[tag=mahjong.agari] mahjongtmp = @s mahjongvalue2
