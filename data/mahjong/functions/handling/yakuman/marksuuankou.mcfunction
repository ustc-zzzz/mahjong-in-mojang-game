...
# set tag
execute if score @s mahjongtmp matches 13 run tag @s add mahjong.yaku.suuankou
execute if score @s mahjongtmp matches 26 run tag @s add mahjong.yaku.suuankou2
# set mahjonghan
